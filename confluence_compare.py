...
def main():
    if len(sys.argv) < 3:
        ...
        print("=" * 70)
        print("\nUsage: py confluence_compare.py \"Page 1\" \"Page 2\"")
        print("\nExamples:")
        print("  py confluence_compare.py \"GDD Master\" \"Core Gameplay Loop\"")
        print("  py confluence_compare.py \"Ship System\" \"Fleet Management\"")
